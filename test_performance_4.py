...
from cam.clusterscorecam4 import ClusterScoreCAM2
...
if __name__ == "__main__":
    ...
    num_image = 50
    excel_path = f"/home/infres/xnguyen-24/XAI/ScoreCAM_cluster/results/Lai-T-0.5-softmax-drop50_{num_image}img.xlsx"
    k_vals = list(range(10, 101, 5))
    # k_vals = [5]
