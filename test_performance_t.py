...
from cam.clusterscorecam2_t import ClusterScoreCAM2
...
if __name__ == "__main__":
    ...
    num_image = 50
    excel_path = f"/home/infres/xnguyen-24/XAI/ScoreCAM_cluster/results/T-2-softmax-drop50_{num_image}img.xlsx"
