...
python3 test2.py --mode batch --model "${MODEL}" --dataset "${DATASET}" --excel-path "${EXCEL_PATH}" --k-values "${K_VALUES[@]}" --cam-method "${CAM_METHOD}" --top-n "${TOP_N}" --zero-ratio 0.5 --temperature 0.5