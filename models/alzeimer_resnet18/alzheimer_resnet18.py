...
def main():
    ...
    parser.add_argument("--checkpoint", type=str, default="alzheimer_resnet18.pth", help="File to save best model")
    ...
    # Example of loading model for XAI
    print(f"Loading model for XAI from {args.checkpoint}...")
    xai_model = load_model(args.checkpoint, device)
    # now you can pass xai_model to GradCAM or other XAI methods
